...
export class WebhookController {
  ...
  /**
   * Verificación del webhook de Meta Messenger Platform.
   * Meta hace un GET con hub.challenge para verificar que el endpoint es tuyo.
   *
   * GET /webhook/facebook?hub.mode=subscribe&hub.challenge=...&hub.verify_token=...
   */
  @Get('facebook')
  verifyWebhook(
  ...
  /**
   * Recibe eventos de Meta Messenger (mensajes entrantes, status de entrega/lectura).
   *
